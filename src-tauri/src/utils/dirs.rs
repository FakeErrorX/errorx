...
pub static APP_ID: &str = "io.github.errorx.errorx";
#[cfg(not(feature = "verge-dev"))]
pub static BACKUP_DIR: &str = "errorx-backup";

#[cfg(feature = "verge-dev")]
pub static APP_ID: &str = "io.github.errorx.errorx.dev";
#[cfg(feature = "verge-dev")]
pub static BACKUP_DIR: &str = "errorx-backup-dev";

pub static PORTABLE_FLAG: OnceCell<bool> = OnceCell::new();

pub static CLASH_CONFIG: &str = "config.yaml";
pub static VERGE_CONFIG: &str = "revilx.yaml";
...
pub fn service_path() -> Result<PathBuf> {
    Ok(app_resources_dir()?.join("errorx-service"))
}

#[cfg(windows)]
pub fn service_path() -> Result<PathBuf> {
    Ok(app_resources_dir()?.join("errorx-service.exe"))
}
