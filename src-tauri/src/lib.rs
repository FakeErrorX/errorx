...
pub fn run() {
    ...
    // Initialize builder without devtools for production
    #[cfg(not(debug_assertions))]
    let builder = tauri::Builder::default();

    // Initialize builder with devtools for development
    #[cfg(debug_assertions)]
        ...
        builder = builder.menu(|handle| {
            Menu::with_items(
                ...
                &[&Submenu::with_items(
                    ...
                    "Menu",
                    true,
                    &[&MenuItem::new(handle, "ErrorX", true, None::<String>).unwrap()],
                )
                .unwrap()],
            )
        });
        ...
        tauri::RunEvent::Ready | tauri::RunEvent::Resumed => {
            ...
            #[cfg(target_os = "macos")]
            {
                let main_window = AppHandleManager::global()
                    ...
                    .unwrap();
                let _ = main_window.set_title("ErrorX");
            }
        }
        #[cfg(target_os = "macos")]
