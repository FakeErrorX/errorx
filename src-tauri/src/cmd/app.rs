use super::CmdResult;
use crate::{feat, utils::dirs, wrap_err, core::tray::Tray};
use tauri::Manager;
...
/// Hide the tray icon
#[tauri::command]
pub fn hide_tray() -> CmdResult<()> {
    wrap_err!(Tray::global().set_tray_visible(false))
}

/// Show the tray icon
#[tauri::command]
pub fn show_tray() -> CmdResult<()> {
    wrap_err!(Tray::global().set_tray_visible(true))
}
